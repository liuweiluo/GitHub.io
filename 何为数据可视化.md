...
#### 概念：D3（Data-Driven Documents 或 D3.js）是一个 JavaScript 库
...
webGL是一种3D绘图协议，这种绘图技术标准允许把JavaScript和OpenGL ES 2.0结合在一起操作显卡去展示3D模型

Threejs是由webGL封装而成的3D库，它们之间的关系就类似原生JS与JQ的关系。
